...
def cross_validation(train_data):
    ...
    for train_index, valid_index in kf.split(X_train, y_train):
        ...
        ada_model = lgb.LGBMClassifier(n_estimators=500, max_depth=15, learning_rate=0.1,class_weight='balanced',random_state=42)
    ...
    np.save('LightGBM_BE_train_mean_tpr.npy', mean_tpr)
...
def ind_test_10time(train_data,ind_test_data):
    ...
    for i in range(10):
        ...
        ada_clf = lgb.LGBMClassifier(n_estimators=500, max_depth=15, learning_rate=0.1,class_weight='balanced',random_state=random_seed)
        random_seed += 10
    ...
    np.save('LightGBM_BE_test_mean_tpr.npy', mean_tpr)
