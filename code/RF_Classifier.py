...
def cross_validation(train_data):
    ...
    for train_index, valid_index in kf.split(X_train, y_train):
        ...
        ada_model = RandomForestClassifier(n_estimators=500, criterion='gini', max_depth=10,
    ...
    np.save('RF_BE_train_mean_tpr.npy', mean_tpr)
...
def ind_test_10time(train_data,ind_test_data):
    ...
    for i in range(10):
        ...
        ada_clf = RandomForestClassifier(n_estimators=500, criterion='gini', max_depth=10,
                                        min_samples_split=2, min_samples_leaf=1,
                                        min_weight_fraction_leaf=0.0,
                                        max_leaf_nodes=10, min_impurity_decrease=0.0, bootstrap=True,
    ...
    np.save('RF_BE_test_mean_tpr.npy', mean_tpr)
